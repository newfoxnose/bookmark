    ...
    <h4>
        ...
        for ($i = 0; $i < count($grades); $i++) {
            if ($grades[$i] == $grade) {
                ...
                ?>
                <a href="<?php echo site_url('user/list_documents/' . $grades[$i] . '/' . $subject_id . '/' . $category_id); ?>">
                    <?php echo $cngrades[$i]; ?>
                </a>
                <?php
            }
    ...
    <h4>
        ...
        foreach ($subjects as $subjects_item):
            if ($subjects_item['id'] == $subject_id) {
                ...
                ?>
                <a href="<?php echo site_url('user/list_documents/' . $grade . '/' . $subjects_item['id'] . '/' . $category_id); ?>"><?php echo $subjects_item['name']; ?></a>
                <?php
            }
        endforeach; ?>
    </h4>
    <h4>
        ...
        foreach ($document_categories as $item):
            if ($item['id'] == $category_id) {
                ...
                ?>
                <a href="<?php echo site_url('user/list_documents/' . $grade . '/' . $subject_id . '/' . $item['id']); ?>"><?php echo $item['name']; ?></a>
                <?php
            }
        endforeach; ?>
    </h4>
    ...
    for ($i = 0; $i < count($documents); $i++) {
        ...
        <div class="documents mytree">
            ...
            <div style="text-align:left;padding-left:10px;">
                ...
                <Br>提供人：<?php echo $teacher_arr[$documents[$i]["upload_teacher_id"]] ?>
                <Br><a href="<?php echo $qiniu_file ?>"
                       target="_blank">下载（右键另存为）</a>
                <br>
                <a href="<?php echo site_url('user/delete_document_qiniu/' . $grade . '/' . $subject_id . '/' . $category_id . '/' . $documents[$i]["id"]); ?>"
